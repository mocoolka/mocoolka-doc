...
import {App,Content} from 'mocoolka-ui-components/lib/App';
 import colorcolor from  '../../../input/color/Color.tsx'
 import colorcolorhover from  '../../../input/color/ColorHover.tsx'
 import colorbgcolor from  '../../../input/color/BgColor.tsx'
 import colorbgcolorhover from  '../../../input/color/BgColorHover.tsx'
 import colorpalette from  '../../../input/color/Palette.tsx'
export const Page =()=> {
    return (
...
`}
            githubLocation={`mocoolka-ui-compontents/docs/src/input/color/Color.tsx`}
          />
...
`}
            githubLocation={`mocoolka-ui-compontents/docs/src/input/color/ColorHover.tsx`}
          />
...
`}
            githubLocation={`mocoolka-ui-compontents/docs/src/input/color/BgColor.tsx`}
          />
...
`}
            githubLocation={`mocoolka-ui-compontents/docs/src/input/color/BgColorHover.tsx`}
          />
...
`}
            githubLocation={`mocoolka-ui-compontents/docs/src/input/color/Palette.tsx`}
          />
