...
export declare type Manys<T> = T | T[];
export declare type TPropertyName = string | number | symbol;
export declare type TManyPropertyName = string | number | string[] | number[];
export declare type GetProperty = (propName: Manys<TPropertyName>) => (a: object) => any;
